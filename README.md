...
## Round 1 update — additional Vercel environment variable
...
This is needed for the receipt scanning feature (the request now goes through a
server-side proxy to avoid browser security restrictions).
